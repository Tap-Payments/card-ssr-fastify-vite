import { Integration, Currencies, Direction, Edges, Locale, Scope, Theme } from '../types/enums.js';
import type { OldPaymentOptions } from '../types/configOld.js';
import { getMappedConfigObject } from './getMappedConfigObject.js';
import type { ConfigObject, Device } from '../types/config.js';
import { Purpose } from '../../shared/types/index.js';
import { PAYMENT_METHODS } from '../../shared/types/paymentOption.js';
