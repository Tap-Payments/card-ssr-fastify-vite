...
import {
  changeHolderNameValue,
  getHolderName,
  resetHolderNameValue,
} from "@features/holdernameSlice";
import {
  getExactCardValue,
  resetCard,
  setMode,
...
export const useEvents = () => {
  ...
  const { globalMode, loadedCard, saveCardForLater } =
    useSelector(getGlobalState);
