...
export function useInputStyle() {
  ...
  const style: React.CSSProperties = {
    backgroundColor: getColorProperty(
      theme.inlineCard.commonAttributes.backgroundColor,
    ),
    ...
    "-webkit-text-fill-color": getColorProperty(
      theme.inlineCard.textFields.textColor,
    ),
