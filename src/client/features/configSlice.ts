...
import type { Features, configPaymentOption, configProps } from '@shared/types/configProps'
import type { CURRENCIES, PaymentOption, SupportedCards } from '@shared/types/paymentOption'
import API from '../api'
